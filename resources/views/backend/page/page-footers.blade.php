...
<div class="card px-4 mb-4">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3">
        <p class="col-md-4 mb-0 text-muted">© 2022 <a href="javascript:void(0)">LUNO</a>. <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0)"> ThemeMakker </a></p>
...
<div class="card px-4 mb-4">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-4">
        <div class="col-md-4 d-flex align-items-center">
            ...
            <span class="text-muted">© 2022 <a href="javascript:void(0)">LUNO</a>. <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0)"> ThemeMakker </a></span>
        </div>
    
        <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
            <li class="ms-3"><a class="text-muted" href="#"><span class="fa-lg fa fa-dribbble text-primary"></span></a></li>
            <li class="ms-3"><a class="text-muted" href="#"><span class="fa-lg fa fa-github text-primary"></span></a></li>
            <li class="ms-3"><a class="text-muted" href="#"><span class="fa-lg fa fa-twitter text-primary"></span></a></li>
        </ul>
    </footer>
</div> <!-- .row end -->
...
<div class="card px-4 mb-4">
    <footer class="py-3 my-4">
        ...
        <p class="text-center text-muted">© 2022 <a href="javascript:void(0)">LUNO</a>. <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0)"> ThemeMakker </a></p>
    </footer>
</div> <!-- .row end -->
...
<div class="card px-4 mb-4">
    <footer class="row row-cols-5 py-5">
        <div class="col">
            ...
            <p>Habitasse vivamus non dictum malesuada viverra aliquam mus facilisis ex curabitur leo magnis maecenas nunc cras</p>
            <p class="text-muted">© 2022 <a href="javascript:void(0)">LUNO</a>. <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0)"> ThemeMakker </a></p>
        </div>
        ...
        <div class="col">
            ...
            <ul class="nav flex-column">
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 color-400">Home</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 color-400">Features</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 color-400">Pricing</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 color-400">FAQs</a></li>
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 color-400">About</a></li>
            </ul>
        </div>
...
<div class="card px-4 mb-4">
    <footer class="py-4">
        ...
        <div class="d-flex justify-content-between pt-4 mt-4 border-top">
            <p>© 2022 <a href="javascript:void(0)">LUNO</a>. <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0)"> ThemeMakker </a></p>
            <ul class="list-unstyled d-flex">
                <li class="ms-3"><a class="link-dark" href="#"><span class="fa-lg fa fa-dribbble text-primary"></span></a></li>
                <li class="ms-3"><a class="link-dark" href="#"><span class="fa-lg fa fa-github text-primary"></span></a></li>
                <li class="ms-3"><a class="link-dark" href="#"><span class="fa-lg fa fa-twitter text-primary"></span></a></li>
            </ul>
        </div>
    </footer>
</div> <!-- .row end -->
