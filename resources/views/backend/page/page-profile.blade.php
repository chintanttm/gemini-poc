    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body border-bottom">
                <div class="d-flex align-items-md-start align-items-center flex-column flex-md-row">
                    <img src="{{ url('/') }}/assets/images/profile_av.png" alt="" class="rounded-4">
                    <div class="media-body ms-md-5 m-0 mt-4 mt-md-0 text-md-start text-center">
                        <h4 class="mb-1 fw-light">Allie Grater<a href="#" class="fa fa-pencil-square-o fs-6 ms-2" data-bs-toggle="offcanvas" data-bs-target="#edit_profile" title="Edit Profile"></a></h4>
                        <p>alliegrater@luno.com</p>
        ...
        <div class="tab-content mt-4 mb-4">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <p class="text-muted">Augue mauris dignissim arcu, ut venenatis metus ante eu orci. Donec non maximus neque, ut finibus ex. <a href="#">Read more</a></p>
                                ...
                                <div class="progress mt-1 mb-3" style="height: 3px;">
                                    <div class="progress-bar chart-color1" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100" style="width: 95%;"></div>
                                </div>
                                <div class="d-flex justify-content-between">
                                ...
                                <div class="progress mt-1 mb-3" style="height: 3px;">
                                    <div class="progress-bar chart-color2" role="progressbar" aria-valuenow="77" aria-valuemin="0" aria-valuemax="100" style="width: 77%;"></div>
                                </div>
                                <div class="d-flex justify-content-between">
                                ...
                                <div class="progress mt-1 mb-3" style="height: 3px;">
                                    <div class="progress-bar chart-color3" role="progressbar" aria-valuenow="66" aria-valuemin="0" aria-valuemax="100" style="width: 66%;"></div>
                                </div>
                                <div class="d-flex justify-content-between">
                                ...
                                <div class="progress mt-1 mb-3" style="height: 3px;">
                                    <div class="progress-bar chart-color4" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%;"></div>
                                </div>
                                <div class="d-flex justify-content-between">
                                ...
                                <div class="progress mt-1 mb-0" style="height: 3px;">
                                    <div class="progress-bar chart-color5" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width: 85%;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <li class="card mb-2">
                                ...
                                <div class="card-body">
                                    <div class="post-detail">
                                        ...
                                        <a class="fancybox img-fluid" rel="ligthbox" href="{{ url('/') }}/assets/images/gallery/11.jpg">
                                            <img class="img-fluid rounded-4" alt="" src="{{ url('/') }}/assets/images/gallery/11.jpg" />
                                        </a>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="post-detail">
                                        ...
                                        <a class="fancybox img-fluid" rel="ligthbox" href="{{ url('/') }}/assets/images/gallery/10.jpg">
                                            <img class="img-fluid rounded-4 w120" alt="" src="{{ url('/') }}/assets/images/gallery/10.jpg" />
                                        </a>
                                        <a class="fancybox img-fluid" rel="ligthbox" href="{{ url('/') }}/assets/images/gallery/12.jpg">
                                            <img class="img-fluid rounded-4 w120" alt="" src="{{ url('/') }}/assets/images/gallery/12.jpg" />
                                        </a>
                                        <a class="fancybox img-fluid" rel="ligthbox" href="{{ url('/') }}/assets/images/gallery/13.jpg">
                                            <img class="img-fluid rounded-4 w120" alt="" src="{{ url('/') }}/assets/images/gallery/13.jpg" />
                                        </a>
                                    </div>
                                    <div class="post-action">
                                        <div class="mb-2 mt-4">
                    ...
                    <div class="col-xxl-3 col-xl-12 col-lg-12 col-md-12">
                        <div class="card mb-3">
                            ...
                            <ul class="list-group list-group-flush list-group-custom">
                                <li class="list-group-item px-4"><a class="d-flex justify-content-between" href="#">Web Design <span>78</span></a></li>
                                <li class="list-group-item px-4"><a class="d-flex justify-content-between" href="#">ReactJs <span>23</span></a></li>
                                <li class="list-group-item px-4"><a class="d-flex justify-content-between" href="#">Music <span>12</span></a></li>
                                <li class="list-group-item px-4"><a class="d-flex justify-content-between" href="#">Trending <span>41</span></a></li>
                                <li class="list-group-item px-4"><a class="d-flex justify-content-between" href="#">Newest Blog <span>8</span></a></li>
                            </ul>
                        </div>
                        <div class="card mb-3">
                            <div class="card-body">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <h6 class="card-title mb-0">Photos (1,025)</h6>
                                <div class="dropdown morphing scale-left">
                                    <a href="#" class="more-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-h"></i></a>
                                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow border-0">
                                        <li class="fw-bold">Quick Actions</li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><a class="dropdown-item" href="#">View Details<i class="fa fa-arrow-right"></i></a></li>
                                        <li><a class="dropdown-item" href="#">Share<i class="fa fa-arrow-right"></i></a></li>
                                        <li><a class="dropdown-item" href="#">Download<i class="fa fa-arrow-right"></i></a></li>
                                        <li><a class="dropdown-item" href="#">Copy to<i class="fa fa-arrow-right"></i></a></li>
                                        <li><a class="dropdown-item" href="#">Move to<i class="fa fa-arrow-right"></i></a></li>
                                        <li><a class="dropdown-item" href="#">Rename<i class="fa fa-arrow-right"></i></a></li>
                                        <li><a class="dropdown-item" href="#">Delete<i class="fa fa-arrow-right"></i></a></li>
                                        <li><hr class="dropdown-divider"></li>
            ...
            <div class="tab-pane fade" id="profile_groups" role="tabpanel">
                ...
                <div class="row row-cols-xxl-5 row-cols-xl-4 row-cols-lg-4 row-cols-lg-3 row-cols-sm-2 row-cols-1 g-3 row-deck">
                    <div class="col">
                        <div class="card text-center overflow-visible">
                            ...
                            <div class="card-body d-flex align-items-center justify-content-between flex-column">
                                <div class="me-auto ms-auto py-4">
                                    ...
                                    <img class="avatar rounded-circle m-1 lift" src="{{ url('/') }}/assets/images/xs/avatar4.jpg" data-bs-toggle="tooltip" data-placement="top" title="Avatar Name" alt="">
                ...
                <div class="row-title mb-3">
                    ...
                    <div>
                        <div class="input-group">
                            ...
                            <button class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#CreateNew" type="button">Create Project</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="profile_campaigns" role="tabpanel">
                <div class="row-title mb-3">
                    <h5>Campaigns <button type="button" class="btn btn-link" data-bs-toggle="modal" data-bs-target="#CreateCampaigns"><i class="fa fa-plus"></i></button></h5>
                    <div>
                        <ul class="nav nav-tabs tab-page-toolbar rounded-pill d-inline-flex" role="tablist">
                            <li class="nav-item"><a class="nav-link rounded-pill border-0 active" data-bs-toggle="tab" href="#campaigns_statistics" role="tab" aria-selected="true">Statistics</a></li>
                            <li class="nav-item"><a class="nav-link rounded-pill border-0" data-bs-toggle="tab" href="#campaigns_list" role="tab" aria-selected="false">Campaigns List</a></li>
                        </ul>
                    </div>
                </div>
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="campaigns_statistics" role="tabpanel">
                        <div class="row g-3 row-deck">
                    ...
                    <div class="tab-pane fade" id="campaigns_list" role="tabpanel">
                        <div class="row g-2 row-deck">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex align-items-md-start align-items-center flex-column flex-md-row">
                                        <img class="w180 rounded" src="{{ url('/') }}/assets/images/gallery/1.jpg" alt="">
                                        <div class="media-body ms-4 text-md-start text-center w-100">
                                            <h5 class="fw-light mb-1">LUNO - Bootstrap 5 Responsive Admin Dashboard Theme</h5>
                                            <p class="text-muted"><span class="badge rounded-pill bg-primary">Draft</span> - Lorem Ipsum has been the industry's standard dummy text ever since the printer took a galley of type and scrambled</p>
                                            <div class="row row-cols-xl-6 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2 g-2">
                                                <div class="col">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex align-items-md-start align-items-center flex-column flex-md-row">
                                        <img class="w180 rounded" src="{{ url('/') }}/assets/images/gallery/2.jpg" alt="">
                                        <div class="media-body ms-4 text-md-start text-center w-100">
                                            <h5 class="fw-light mb-1">Alpino - Bootstrap 4 Admin Dashboard Template</h5>
                                            <p class="text-muted"><span class="badge rounded-pill bg-warning">Scheduled</span> - Lorem Ipsum has been the industry's standard dummy text ever since the printer took a galley of type and scrambled</p>
                                            <div class="row row-cols-xl-6 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2 g-2">
                                                <div class="col">
                                                    <strong>22 Dec 2021</strong>
                                                    <div class="text-muted small">Date</div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex align-items-md-start align-items-center flex-column flex-md-row">
                                        <img class="w180 rounded" src="{{ url('/') }}/assets/images/gallery/3.jpg" alt="">
                                        <div class="media-body ms-4 text-md-start text-center w-100">
                                            <h5 class="fw-light mb-1">Aero - Bootstrap 5 & 4 Admin Template with Laravel & Angular version</h5>
                                            <p class="text-muted"><span class="badge rounded-pill bg-success">Published</span> - Lorem Ipsum has been the industry's standard dummy text ever since the printer took a galley of type and scrambled</p>
                                            <div class="row row-cols-xl-6 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2 g-2">
                                                <div class="col">
                                                    <strong>22 Dec 2021</strong>
                                                    <div class="text-muted small">Date</div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex align-items-md-start align-items-center flex-column flex-md-row">
                                        <img class="w180 rounded" src="{{ url('/') }}/assets/images/gallery/4.jpg" alt="">
                                        <div class="media-body ms-4 text-md-start text-center w-100">
                                            <h5 class="fw-light mb-1">Compass RealEstate - HTML Admin Template</h5>
                                            <p class="text-muted"><span class="badge rounded-pill bg-warning">Scheduled</span> - Lorem Ipsum has been the industry's standard dummy text ever since the printer took a galley of type and scrambled</p>
                                            <div class="row row-cols-xl-6 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2 g-2">
                                                <div class="col">
                                                    <strong>22 Dec 2021</strong>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex align-items-md-start align-items-center flex-column flex-md-row">
                                        <img class="w180 rounded" src="{{ url('/') }}/assets/images/gallery/5.jpg" alt="">
                                        <div class="media-body ms-4 text-md-start text-center w-100">
            ...
            <div class="offcanvas-body">
                <form class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control" placeholder="alliegrater@luno.com">
                    </div>
                    <div class="col-md-6">
...
<script>
    ...
    $("#tab_profile_campaigns").on("click",function() {
        setTimeout(function() {
            new ApexCharts(document.querySelector("#apex_c_1"), apexwc2).render();
