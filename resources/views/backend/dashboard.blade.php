...
<div class="row g-3 row-deck">
    <div class="col-lg-3 col-md-6 col-sm-6">
        <div @class(['card overflow-hidden','shadow-active' => $setting->card_box_shadow == 'Y'])>
            <div class="card-body">
    ...
    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-12">
        <div @class(['card text-center bg-primary-gradient','shadow-active' => $setting->card_box_shadow == 'Y'])>
            <div class="card-body d-flex align-items-center justify-content-center">
                <div>
                    ...
                    <a class="btn btn-lg bg-white text-uppercase" href="{{ route('admin.page.page-pricing') }}" title="">Update now</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-xxl-6 col-xl-8 col-lg-8">
        <div @class(['card','shadow-active' => $setting->card_box_shadow == 'Y'])>
