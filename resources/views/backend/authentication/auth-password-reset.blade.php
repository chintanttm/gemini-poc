        ...
        <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
            ...
            <form class="row g-3">
                ...
                <div class="col-12 text-center mt-4">
                    <a href="{{ route('admin.authentication.auth-signin') }}" title="" class="btn btn-lg btn-block btn-dark lift text-uppercase">SUBMIT</a>
                </div>
                <div class="col-12 text-center mt-4">
                    <span class="text-muted"><a href="{{ route('admin.authentication.auth-signin') }}">Back to Sign in</a></span>
                </div>
            </form>
            <!-- End Form -->
        </div>
