        ...
        <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
            ...
            <form class="row g-3">
                <div class="col-12 text-center mb-5">
                    <img src="{{ url('/') }}/assets/images/auth-two-step.svg" class="w240 mb-4" alt="" />
                    <h1>2-step Verification</h1>
                    <span class="text-muted">We sent a verification code to your email. Enter the code from the email in the field below.</span>
                </div>
                <div class="col">
                    <div class="mb-2">
                ...
                <div class="col-12 text-center mt-4">
                    <a href="{{ route('admin.dashboard') }}" title="" class="btn btn-lg btn-block btn-dark lift text-uppercase">Verify my account</a>
                </div>
                <div class="col-12 text-center mt-4">
