        ...
        <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
            ...
            <form class="row g-3">
                <div class="col-12 text-center mb-4">
                    <img src="{{ url('/') }}/assets/images/auth-maintenance.svg" class="w240 mb-4" alt="" />
                    <h1 class="display-6">Under Construction!</h1>
                    <p class="lead text-muted">To make things right we need some time to rebuild</p>
                </div>
                <div class="col-12">
                    <div class="text-muted text-center mb-1">Get notified when we are done.</div>
                ...
                <div class="col-12 text-center">
                    <a href="{{ route('admin.dashboard') }}" title="" class="btn btn-lg btn-block btn-dark lift text-uppercase">Send</a>
                </div>
            </form>
            <!-- End Form -->
        </div>
