        ...
        <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
            ...
            <form class="row g-3">
                ...
                <div class="col-12 text-center mt-4">
                    <a class="btn btn-lg btn-block btn-dark lift text-uppercase" href="{{ route('admin.dashboard') }}" title="">SIGN IN</a>
                </div>
                <div class="col-12 text-center mt-4">
                    <span class="text-muted">Don't have an account yet? <a href="{{ route('admin.authentication.auth-signup') }}">Sign up here</a></span>
                </div>
            </form>
            <!-- End Form -->
        </div>
