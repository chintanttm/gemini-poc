        ...
        <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
            ...
            <form class="row g-3">
                <div class="col-12 text-center mb-4">
                    <img src="{{ url('/') }}/assets/images/auth-500.svg" class="w240 mb-4" alt="" />
                    <h1 class="display-1">500</h1>
                    <h5>Internal Server Error</h5>
                    <span class="text-muted">The server has been deserted for a while. Please be patient or try again later.</span>
                </div>
                <div class="col-12 text-center">
                    <a href="{{ route('admin.dashboard') }}" title="" class="btn btn-lg btn-block btn-dark lift text-uppercase">Back to Home</a>
                </div>
            </form>
            <!-- End Form -->
        </div>
