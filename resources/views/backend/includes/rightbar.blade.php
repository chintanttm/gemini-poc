<div class="rightbar card">
        ...
        <h6 class="card-title btn-right mb-0">
            <a href="#" title="Settings">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
                    <path class="fill-muted" d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293 5.354 4.646z"/>
                </svg>
            </a>
            Rightbar
        </h6>
    ...
    <ul class="nav nav-tabs tab-card text-center" role="tablist">
        <li class="nav-item flex-fill"><a class="nav-link active" data-bs-toggle="tab" href="#rightbar_home" role="tab">Home</a></li>
        <li class="nav-item flex-fill"><a class="nav-link" data-bs-toggle="tab" href="#rightbar_profile" role="tab">Profile</a></li>
        <li class="nav-item flex-fill"><a class="nav-link" data-bs-toggle="tab" href="#rightbar_contact" role="tab">Contact</a></li>
    </ul>
    <div class="card-body custom_scroll">
        <div class="tab-content">
            <div class="tab-pane fade show active" id="rightbar_home" role="tabpanel">
                <div class="row g-3">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center my-4">
                                    ...
                                    <div class="flex-fill ms-3">
                                        ...
                                        <small class="text-muted">Senior Go Developer at Facebook</small>
                                    </div>
                                </div>
                                <div class="d-flex">
                    ...
                    <div class="col-12">
                        <div class="card bottom-0 bg-primary text-light position-relative">
                            <div class="card-body">
            ...
            <div class="tab-pane fade" id="rightbar_profile" role="tabpanel">
                <div class="row g-3">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="image-input avatar xxl rounded-circle shadow" style="background-image: url({{ url('/') }}/assets/images/avatar.png)">
                                ...
                                <a href="{{ route('admin.page.page-profile') }}"><h5 class="mb-0 mt-3">Allie Grater</h5></a>
                                <span class="small text-uppercase text-muted">CEO - Founder</span>
                                <div class="mt-3">
                                    <a href="#" class="p-2 color-400"><i class="fa fa-facebook-f"></i></a>
                                    <a href="#" class="p-2 color-400"><i class="fa fa-twitter"></i></a>
                                    <a href="#" class="p-2 color-400"><i class="fa fa-instagram"></i></a>
                                    <a href="#" class="p-2 color-400"><i class="fa fa-linkedin"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row row-cols-lg-3 row-cols-md-4 row-cols-sm-3 row-cols-3 g-1">
                                    <div class="col"><a href="#" class="d-block"><img class="img-fluid rounded" src="{{ url('/') }}/assets/images/gallery/1.jpg" alt=""></a></div>
                                    <div class="col"><a href="#" class="d-block"><img class="img-fluid rounded" src="{{ url('/') }}/assets/images/gallery/2.jpg" alt=""></a></div>
                                    <div class="col"><a href="#" class="d-block"><img class="img-fluid rounded" src="{{ url('/') }}/assets/images/gallery/3.jpg" alt=""></a></div>
                                    <div class="col"><a href="#" class="d-block"><img class="img-fluid rounded" src="{{ url('/') }}/assets/images/gallery/4.jpg" alt=""></a></div>
                                    <div class="col"><a href="#" class="d-block"><img class="img-fluid rounded" src="{{ url('/') }}/assets/images/gallery/5.jpg" alt=""></a></div>
                                    <div class="col"><a href="#" class="d-block"><img class="img-fluid rounded" src="{{ url('/') }}/assets/images/gallery/6.jpg" alt=""></a></div>
                                    <div class="col"><a href="#" class="d-block"><img class="img-fluid rounded" src="{{ url('/') }}/assets/images/gallery/7.jpg" alt=""></a></div>
                                    <div class="col"><a href="#" class="d-block"><img class="img-fluid rounded" src="{{ url('/') }}/assets/images/gallery/8.jpg" alt=""></a></div>
                                    <div class="col"><a href="#" class="d-block"><img class="img-fluid rounded" src="{{ url('/') }}/assets/images/gallery/9.jpg" alt=""></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="tab-pane fade" id="rightbar_contact" role="tabpanel">
                <ul class="list-group list-group-custom mb-0">
                    <li class="list-group-item">
                        <a href="{{ route('admin.applications.app-chat') }}" class="d-flex align-items-center color-600">
                            <img class="avatar rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar1.jpg" alt="">
                            <div class="flex-fill ms-3 text-truncate">
                                <h6 class="mb-0">Chris Fox</h6>
                                <small class="text-muted">ChrisFox@luno.com</small>
                            </div>
                            <button class="btn btn-sm small btn-animate-2 pulse rounded-circle"><i class="fa fa-comments"></i></button>
                        </a>
                    </li>
                    <li class="list-group-item">
                        <a href="{{ route('admin.applications.app-chat') }}" class="d-flex align-items-center color-600">
                            ...
                            <div class="flex-fill ms-3 text-truncate">
                                ...
                                <small class="text-muted">RobertHammer@luno.com</small>
                            </div>
                            <button class="btn btn-sm small btn-animate-2 pulse rounded-circle"><i class="fa fa-comments"></i></button>
                        </a>
                    </li>
                    ...
                    <li class="list-group-item">
                        <a href="{{ route('admin.applications.app-chat') }}" class="d-flex align-items-center color-600">
                            <img class="avatar rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar9.jpg" alt="">
                            <div class="flex-fill ms-3 text-truncate">
                                <h6 class="mb-0">Robert Hammer</h6>
                                <small class="text-muted">RobertHammer@luno.com</small>
                            </div>
