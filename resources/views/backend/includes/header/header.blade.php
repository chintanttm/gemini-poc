...
@endphp
<header @class([ 'page-header px-xl-4 px-sm-2 px-0 py-lg-2 py-1', 'sticky-top' => $setting->page_header_fix == 'Y', 'dark' => $setting->page_header_dark_mode == 'Y'])>
    <div class="{{ $setting->container_fluid == 'Y' ? 'container-fluid' : 'container' }}">
        <nav class="navbar">
            <!-- start: toggle btn -->
            @if($setting['fullscreen_menu'] == 'Y')
                <div class="d-flex align-items-center">
                    <button type="button" class="btn btn-link p-0 text-muted" data-bs-toggle="modal" data-bs-target="#megamenu">
            ...
            <div class="header-left flex-grow-1 d-none d-md-block">
                <div class="main-search px-3 flex-fill">
                    ...
                    <div @class(['card shadow rounded-4 search-result slidedown','shadow-active' => $setting->card_box_shadow == 'Y'])>
                        {{-- <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap align-items-start mt-2 mb-4">
                                ...
                                <a class="small rounded py-1 px-2 m-1 fw-normal bg-info text-white" href="{{ route('admin.applications.app-project') }}">Project</a>
                                <a class="small rounded py-1 px-2 m-1 fw-normal bg-dark text-white" href="{{ route('admin.applications.app-social') }}">Social App</a>
                            ...
                            <div @class(['card list-group list-group-flush list-group-custom mt-2','shadow-active' => $setting->card_box_shadow == 'Y'])>
            ...
            <ul class="header-right justify-content-end d-flex align-items-center mb-0">
                ...
                <li>
                    <div class="dropdown morphing scale-left notifications">
                        ...
                        <div id="NotificationsDiv" class="dropdown-menu shadow rounded-4 border-0 p-0 m-0">
                            <div @class(['card w380','shadow-active' => $setting->card_box_shadow == 'Y'])>
                ...
                <li class="d-none d-xl-inline-block">
                    <div class="dropdown morphing scale-left Language mx-sm-2">
                        ...
                        <div class="dropdown-menu rounded-4 shadow border-0 p-0" data-bs-popper="none">
                            <div @class(['card border-0','shadow-active' => $setting->card_box_shadow == 'Y'])>
                        ...
                        <div class="dropdown-menu rounded-4 shadow border-0 p-0" data-bs-popper="none">
                            <div @class(['card border-0','shadow-active' => $setting->card_box_shadow == 'Y'])>
                                <div class="row g-1 text-center p-3" style="width: 302px;">
                                    <div class="col-6">
                                        <a @class(['card p-3 color-600 lift align-items-center','shadow-active' => $setting->card_box_shadow == 'Y']) href="{{ route('admin.dashboard') }}" title="">
                                    ...
                                    <div class="col-6">
                                        {{-- <a @class(['card p-3 color-600 lift align-items-center','shadow-active' => $setting->card_box_shadow == 'Y']) href="{{ route('admin.applications.app') }}" title="">
                                            <svg viewBox="0 0 16 16" width="30px" class="mb-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="col-6">
                                        <a @class(['card p-3 color-600 lift align-items-center','shadow-active' => $setting->card_box_shadow == 'Y']) href="{{ route('admin.page.crafted-page') }}" title="">
                                            <svg viewBox="0 0 16 16" width="30px" class="mb-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="col-6">
                                        <a @class(['card p-3 color-600 lift align-items-center','shadow-active' => $setting->card_box_shadow == 'Y']) href="{{ route('admin.layouts') }}" title="">
                                            <svg viewBox="0 0 16 16" width="30px" class="mb-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <li >
                    <a id="dark_mode" class="nav-link quick-light-dark " href="#">
                        <svg viewBox="0 0 16 16" width="18px" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                        <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#" role="button" data-bs-toggle="dropdown">
                            <img class="avatar img-thumbnail rounded-circle shadow" src="{{url('/')}}/assets/images/profile_av.png" alt="">
                        </a>
                        <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                            <div @class(['card border-0 w240','shadow-active' => $setting->card_box_shadow == 'Y'])>
                                ...
                                <div class="list-group m-2 mb-3">
                                    <a class="list-group-item list-group-item-action border-0" href="{{ route('admin.page.page-profile') }}"><i class="w30 fa fa-user"></i>Profile & account</a>
                                    <a class="list-group-item list-group-item-action border-0" href="{{ route('admin.account.account-settings') }}"><i class="w30 fa fa-gear"></i>Settings</a>
                                    <a class="list-group-item list-group-item-action border-0" href="{{ route('admin.page.page-support-ticket') }}"><i class="w30 fa fa-tag"></i>Support Ticket</a>
                                    <a class="list-group-item list-group-item-action border-0" href="{{ route('admin.page.page-teamsboard') }}"><i class="w30 fa fa-users"></i>Manage team</a>
