                    ...
                    <div class="col-lg-8 col-sm-12">
                        ...
                        <div class="bd-example mb-5">
                            <div class="card" style="width: 18rem;">
                                <img class="card-img-top" src="{{ url('/') }}/assets/images/gallery/1.jpg" alt="" />
                                <div class="card-body">
...
&lt;/div&gt;</code></pre>
                        ...
                        <div class="bd-example mb-5">
                            <div class="card" style="width: 18rem;">
                                <img class="card-img-top" src="{{ url('/') }}/assets/images/gallery/2.jpg" alt="" />
...
&lt;/div&gt;</code></pre>
                        ...
                        <div class="bd-example mb-5">
                            <div class="card" style="width: 18rem;">
                                <img class="card-img-top" src="{{ url('/') }}/assets/images/gallery/6.jpg" alt="" />
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                </div>
...
&lt;/div&gt;</code>
                        ...
                        <div class="bd-example mb-5">
                            <div class="card mb-3">
                                <img class="card-img-top" src="{{ url('/') }}/assets/images/gallery/10.jpg" alt="" />
                            ...
                            <div class="card">
                                ...
                                <img class="card-img-top" src="{{ url('/') }}/assets/images/gallery/8.jpg" alt="" />
...
&lt;/div&gt;</code>
                        ...
                        <div class="bd-example mb-5">
                            <div class="card mb-3" style="max-width: 540px;">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img class="card-img-top" src="{{ url('/') }}/assets/images/gallery/5.jpg" alt="" />
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
...
&lt;/div&gt;</code>
                        ...
                        <div class="bd-example mb-5">
                            <div class="row row-cols-1 row-cols-md-2 g-4">
                                ...
                                <div class="col">
                                    <div class="card">
                                        <img class="card-img-top" src="{{ url('/') }}/assets/images/gallery/9.jpg" alt="" />
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                                            <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                        </div>
                                ...
                                <div class="col">
                                    <div class="card">
                                        <img class="card-img-top" src="{{ url('/') }}/assets/images/gallery/3.jpg" alt="" />
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                                            <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                        </div>
...
&lt;/div&gt;</code>
                        ...
                        <div class="bd-example mb-5">
                            <div class="row row-cols-1 row-cols-md-3 g-4">
                                ...
                                <div class="col">
                                    <div class="card h-100">
                                        <img class="card-img-top" src="{{ url('/') }}/assets/images/gallery/7.jpg" alt="" />
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                                            <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.</p>
                                        </div>
                                ...
                                <div class="col">
                                    <div class="card h-100">
                                        <img class="card-img-top" src="{{ url('/') }}/assets/images/gallery/4.jpg" alt="" />
                                        <div class="card-body">
                                            <h5 class="card-title">Card title</h5>
                                            <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                        </div>
