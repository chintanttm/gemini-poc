                                    ...
                                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img class="img-fluid" src="{{ url('/') }}/assets/images/gallery/10.jpg" alt="" />
                                            </div>
                                            <div class="carousel-item">
                                                <img class="img-fluid" src="{{ url('/') }}/assets/images/gallery/8.jpg" alt="" />
                                            </div>
                                            <div class="carousel-item">
                                ...
                                <div class="card-body">
                                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item">
                                                <img class="img-fluid" src="{{ url('/') }}/assets/images/gallery/2.jpg" alt="" />
                                                <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item carousel-item-next carousel-item-left">
                                                <img class="img-fluid" src="{{ url('/') }}/assets/images/gallery/7.jpg" alt="" />
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item carousel-item-next carousel-item-left">
                                                <img class="img-fluid" src="{{ url('/') }}/assets/images/gallery/6.jpg" alt="" />
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h5>Third slide label</h5>
                                                    <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
                                                </div>
