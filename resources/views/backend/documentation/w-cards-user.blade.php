    ...
    <div class="row">
        <div class="col-12">
            <ul class="nav nav-tabs tab-card mb-4 border-top-0 border-start-0 border-end-0 border border-primary rounded-4 bg-white" role="tablist">
                ...
                <li class="nav-item"><a class="py-3 mx-1 nav-link active" href="{{ route('admin.documentation.w-cards-user') }}">User Card's</a></li>
            ...
            <div class="card overflow-visible">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <a href="#" class="avatar"><img src="{{ url('/') }}/assets/images/xs/avatar1.jpg" alt="..." class="rounded-circle"></a>
                        </div>
                        <div class="col ml-n2">
                            <h5 class="mb-1"><a href="#">Manuella Nevoresky</a></h5>
                            <p class="text-muted mb-1">You either die Spongebob or you live long enough to...</p>
                            <p class="small mb-0"><span class="text-success">●</span> Online</p>
                        </div>
                        <div class="col-auto">
                            <a href="#!" class="btn btn-sm btn-primary d-none d-md-inline-block">Subscribe</a>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-lg-4 col-md-12 col-sm-12">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-light-primary">Post</button>
            ...
            <div class="card mb-3 text-center">
                ...
                <div class="card-body d-flex align-items-center justify-content-between flex-column">
                    <div class="me-auto ms-auto py-4">
                        <img class="avatar rounded m-1 lift" src="{{ url('/') }}/assets/images/xs/avatar1.jpg" title="Avatar Name">
                        <img class="avatar rounded m-1 lift" src="{{ url('/') }}/assets/images/xs/avatar2.jpg" title="Avatar Name">
                        <img class="avatar rounded m-1 lift" src="{{ url('/') }}/assets/images/xs/avatar3.jpg" title="Avatar Name">
                        <img class="avatar rounded m-1 lift" src="{{ url('/') }}/assets/images/xs/avatar4.jpg" title="Avatar Name">
                        <img class="avatar rounded m-1 lift" src="{{ url('/') }}/assets/images/xs/avatar5.jpg" title="Avatar Name">
                        <img class="avatar rounded m-1 lift" src="{{ url('/') }}/assets/images/xs/avatar6.jpg" title="Avatar Name">
                        <img class="avatar rounded m-1 lift" src="{{ url('/') }}/assets/images/xs/avatar7.jpg" title="Avatar Name">
                        <img class="avatar rounded m-1 lift" src="{{ url('/') }}/assets/images/xs/avatar8.jpg" title="Avatar Name">
                        <img class="avatar rounded m-1 lift" src="{{ url('/') }}/assets/images/xs/avatar9.jpg" title="Avatar Name">
                    </div>
                    <div class="mt-2">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center my-4">
                        <img class="avatar xl rounded" src="{{ url('/') }}/assets/images/profile_av.png" alt="">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col text-truncate fs-6 fw-bold">Inbox</div>
                        <div class="col-auto">
                            <div class="dropdown morphing scale-left">
                                <a href="#" class="more-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-h"></i></a>
                                <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow border-0">
                    ...
                    <div class="d-flex align-items-center mt-4">
                        <img  class="rounded-circle avatar sm" src="{{ url('/') }}/assets/images/xs/avatar4.jpg" data-bs-toggle="tooltip" title="Avatar Name" alt="Avatar">
                        <div class="ms-2">
                            <a class="fw-bold" href="#" title="">Kevin</a>
                            <span>just sent you an inbox message.</span>
                        </div>
                    </div>
                    <div class="border p-2 mt-3 rounded">
                        <div class="text-success mb-2"><i class="fa fa-circle small me-2"></i><span>Design Project</span></div>
                        <p class="mb-1">Where are we in terms of design? We need to review the new screens.</p>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="d-flex">
                        <img class="avatar rounded" src="{{ url('/') }}/assets/images/xs/avatar2.jpg" alt="">
                        <div class="flex-fill ms-3 text-truncate">
                            <h6 class="d-flex justify-content-between mb-0"><span>Brian Swader</span></h6>
                            <span class="text-muted">Front-end developer</span>
                            <div class="text-muted"><i class="fa fa-money ps-1"></i> $45 per hour</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card overflow-hidden mb-3">
                ...
                <div class="card-body text-center position-relative pt-5">
                    <img class="avatar xl rounded-circle img-thumbnail position-absolute top-0 start-50 translate-middle" src="{{ url('/') }}/assets/images/profile_av.png" alt="">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card mb-3">
                <div class="card-body text-center p-4">
                    <img src="{{ url('/') }}/assets/images/profile_av.png" alt="" class="rounded-circle mb-3 img-thumbnail shadow-sm">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <div class="me-3">
                            <img class="rounded" src="{{ url('/') }}/assets/images/xs/avatar1.jpg" alt="avatar lg" title="">
                        </div>
                        <div class="media-body">
                            <h6 class="mb-0">Hello, I'm<br> Rachel Roth</h6>
                        </div>
                    </div>
                    <span>I design and develop services for customers of all sizes, specializing in creating stylish.</span>
                </div>
            </div>
            <div class="card mb-4">
                <div class="card-body">
                    <div class="d-flex flex-wrap flex-column align-items-center">
                        <div class="mb-3">
                            <img src="{{ url('/') }}/assets/images/profile_av.png" class="rounded-circle img-thumbnail" alt="profile-image">
                        </div>
                        <div class="text-center">
                            <div class="fs-5">Helen Maggie</div>
                            <div class="text-uppercase small mb-3 text-muted">Support team</div>
                            <button class="btn btn-primary"><i class="fa fa-plus me-2"></i>Request Access</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card mb-3">
                ...
                <div class="card-body text-center position-relative pt-5">
                    <img class="avatar xl rounded-circle img-thumbnail position-absolute top-0 start-50 translate-middle" src="{{ url('/') }}/assets/images/profile_av.png" alt="">
                    <h6 class="mt-2 mb-0">Michelle Green</h6>
                    <span class="text-muted">United Kingdom</span>
                </div>
                <div class="card-footer border-top-0 text-center py-3">
                    <div class="d-flex">
                        <div class="flex-fill">
                            <h6 class="fw-bold mb-0">124</h6>
                            <small class="text-muted">Attachments</small>
                        </div>
                        <div class="flex-fill">
                            <h6 class="fw-bold mb-0">452</h6>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <img class="avatar rounded" src="{{ url('/') }}/assets/images/xs/avatar3.jpg" alt="">
                        <div class="flex-fill ms-3">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="avatar rounded" src="{{ url('/') }}/assets/images/xs/avatar4.jpg" alt="">
                        <div class="flex-fill ms-3">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col text-truncate">
                            <div class="fw-bold">Opens</div>
                            <p class="mb-0">Google acconts</p>
                        </div>
                        <div class="col-auto">
                            <img src="{{ url('/') }}/assets/images/xs/avatar6.jpg" data-bs-toggle="tooltip" title="Avatar Name" alt="Avatar" class="rounded-circle avatar">
                        </div>
                    </div>
                    <div class="d-flex my-3">
                        <button class="btn btn-outline-secondary btn-lg flex-fill mx-1"><i class="fa fa-file-excel-o me-2"></i>Google Sheets</button>
                        <button class="btn btn-outline-secondary btn-lg flex-fill mx-1"><i class="fa fa-file me-2"></i>Note</button>
                    </div>
                    <div class="p-3 mb-3 text-center bg-light">
                        <img class="avatar lg rounded-circle img-thumbnail" src="{{ url('/') }}/assets/images/xs/avatar1.jpg" alt="">
                        <h6 class="mt-2 mb-0">Michelle Green</h6>
                        <span class="small text-muted">jason-porter@info.com</span>
                    </div>
                    <span>I design and develop services for customers of all sizes, specializing in creating stylish.</span>
                </div>
            </div>
            <div class="card mb-3">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <img src="{{ url('/') }}/assets/images/xs/avatar4.jpg" data-bs-toggle="tooltip" title="Avatar Name" alt="Avatar" class="rounded-circle avatar">
                        <div class="ms-3">
                            <a href="#" title="">Kevin Gill</a>
                            <p class="mb-0">kevin.gill@example.com</p>
                        </div>
            ...
            <div class="card mb-3">
                <div class="card-body text-center">
                    <img src="{{ url('/') }}/assets/images/xs/avatar4.jpg" data-bs-toggle="tooltip" title="Avatar Name" alt="Avatar" class="rounded-circle avatar lg img-thumbnail">
                    <h6 class="text-truncate mb-0 me-auto mt-3">UI-Design Group</h6>
                    <div class="text-truncate">
                        <i class="fa fa-map me-1"></i> North Carolina, CT
                        <div class="mt-1">
                            <img class="avatar xs rounded" src="{{ url('/') }}/assets/images/xs/avatar5.jpg" data-bs-toggle="tooltip" data-placement="top" title="Avatar">
                            <img class="avatar xs rounded" src="{{ url('/') }}/assets/images/xs/avatar6.jpg" data-bs-toggle="tooltip" data-placement="top" title="Avatar">
                            <img class="avatar xs rounded" src="{{ url('/') }}/assets/images/xs/avatar1.jpg" data-bs-toggle="tooltip" data-placement="top" title="Avatar">
                            <img class="avatar xs rounded" src="{{ url('/') }}/assets/images/xs/avatar4.jpg" data-bs-toggle="tooltip" data-placement="top" title="Avatar">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-lg-4">
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="text-truncate mb-1">UI-Design Group</h6>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="card-title col text-truncate fs-6">New Followers</div>
                        <div class="col-auto">
                            <img class="avatar xs rounded lift" src="{{ url('/') }}/assets/images/xs/avatar1.jpg" title="Avatar Name">
                            <img class="avatar xs rounded lift" src="{{ url('/') }}/assets/images/xs/avatar2.jpg" title="Avatar Name">
                            <img class="avatar xs rounded lift" src="{{ url('/') }}/assets/images/xs/avatar3.jpg" title="Avatar Name">
                        </div>
                    </div>
                    <div class="mt-3 pt-3 border-top">Great News! <span class="text-primary">Marshall</span>, <span class="text-primary">Nellie</span> and <span class="text-primary">Chris</span> are now following you. Take some time to look at their profile.</div>
                </div>
            </div>
            <div class="card bottom-0 mb-3 bg-primary text-light position-relative">
                <div class="card-body">
                    <h5 class="card-title text-light">Transact safely with Lender’s Fund Account (LUNO)</h5>
                    <p class="card-text mb-4">Apply now, quick registration </p>
                ...
                <svg class="position-absolute bottom-0 end-0" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="251.99951" height="127.00734" viewBox="0 0 901.99951 702.00734">
                    ...
                    <path d="M384.00024,757.28868a722.02568,722.02568,0,0,1-213,0v-24a802.32929,802.32929,0,0,0,213,0Z" transform="translate(-171.00024 -88.99633)" fill="#3f3d56"/>
                    <path d="M384.00024,720.28868a722.02568,722.02568,0,0,1-213,0v-24a802.32929,802.32929,0,0,0,213,0Z" transform="translate(-171.00024 -88.99633)" fill="#3f3d56"/>
                    <path d="M384.00024,683.28868a722.02568,722.02568,0,0,1-213,0v-24a802.32929,802.32929,0,0,0,213,0Z" transform="translate(-171.00024 -88.99633)" fill="#3f3d56"/>
                </svg>
            </div>
        </div>
    </div> <!-- .row end -->
