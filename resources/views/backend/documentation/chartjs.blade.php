                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="http://gionkunz.github.io/chartist-js/" target="_blank">plugin's site</a>
                            </div>
...
&lt;script src=&quot;{{ url('/') }}/assets/bundles/chartist.bundle.js&quot;&gt;&lt;/script&gt;
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title">Advanced Smil Animation Chart</h6>
                </div>
                <div class="card-body">
                    <div class="ct-chart" id="C_AnimationChart"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="ct-chart" id="C_LineChart"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title">Holes In Data Chart</h6>
                </div>
                <div class="card-body">
                    <div class="ct-chart" id="C_HolesInData"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title">Filled Holes Data Chart</h6>
                </div>
                <div class="card-body">
                    <div class="ct-chart" id="C_FilledHolesInData"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title">Line Area Chart</h6>
                </div>
                <div class="card-body">
                    <div class="ct-chart" id="C_LineArea"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title">Polar Bar Chart</h6>
                </div>
                <div class="card-body">
                    <div class="ct-chart" id="C_PolarBarChart"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="ct-chart" id="C_StackedBarChart"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="ct-chart" id="C_HorizontalBarChart"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="ct-chart" id="C_PieChart"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title">Gauge Chart</h6>
                </div>
                <div class="card-body">
                    <div class="ct-chart" id="C_GaugeChart"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="ct-chart" id="C_DonutChartStroke"></div>
                </div>
            </div>
        </div>
    </div> <!-- .row end -->
    ...
    <script>
        ...
        $(function () {
            ...
            // Gauge Chart
            new Chartist.Pie('#C_GaugeChart', { series: [20, 10, 30, 40] },{
                donut: true,
                donutWidth: 60,
                startAngle: 270,
                total: 200,
            ...
            new Chartist.Pie('#C_DonutChartStroke', { series: [20, 10, 30, 40]},{
                donut: true,
                donutWidth: 60,
                donutSolid: true,
                startAngle: 270,
