                                                ...
                                                <div class="h-right d-flex align-items-center me-5 me-lg-0 order-1">
                                                                        ...
                                                                        <ul class="list-unstyled list mb-0">
                                                                            <li class="py-2 mb-1 border-bottom">
                                                                                <a href="javascript:void(0);" class="d-flex">
                                                                                    ...
                                                                                    <div class="flex-fill ms-3">
                                                                                        <p class="d-flex justify-content-between mb-0 text-muted"><span class="fw-bold">Allie Grater</span> <small>2MIN</small></p>
                                                                            ...
                                                                            <li class="py-2 mb-1 border-bottom">
                                                                                <a href="javascript:void(0);" class="d-flex">
                                                                                    ...
                                                                                    <div class="flex-fill ms-3">
                                                                                        <p class="d-flex justify-content-between mb-0 text-muted"><span class="fw-bold">Lentz</span> <small>1HR</small></p>
                                                    ...
                                                    <div class="dropdown user-profile ms-2 ms-sm-3">
                                                        <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown">
                                                            <img class="avatar rounded-circle img-thumbnail" src="{{ url('/') }}/assets/images/profile_av.png" alt="">
                                                        </a>
                                                            ...
                                                            <div class="card border-0 w240">
                                                                <div class="card-body border-bottom">
                                                                    <div class="d-flex py-1">
                                                                        ...
                                                                        <div class="flex-fill ms-3">
                                                                            <p class="mb-0 text-muted"><span class="fw-bold">Allie Grater</span></p>
                                                                            <small class="text-muted">alliegrater@luno.com</small>
                                                                            <div>
                                                ...
                                                <div class="collapse navbar-collapse order-0" id="mainHeader">
                                                    <ul class="navbar-nav me-auto">
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <ul class="dropdown-menu rounded-lg shadow border-0 dropdown-animation">
                                                                <li><a class="dropdown-item" href="{{ route('admin.page.page-profile') }}">Profile</a></li>
                                                                <li><a class="dropdown-item" href="{{ route('admin.page.page-timeline') }}">Timeline</a></li>
                                                                <li><a class="dropdown-item" href="{{ route('admin.page.page-imagegallery') }}">Image Gallery</a></li>
                                                                <li><a class="dropdown-item" href="{{ route('admin.account.account-invoices') }}">Invoices</a></li>
                                                                <li><a class="dropdown-item" href="{{ route('admin.page.page-pricing') }}">Pricing</a></li>
                                                                <li><a class="dropdown-item" href="{{ route('admin.page.page-teamsboard') }}">Teams Board</a></li>
                                                                <li><a class="dropdown-item" href="{{ route('admin.page.page-faqs') }}">FAQs</a></li>
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <ul class="dropdown-menu rounded-lg shadow border-0 dropdown-animation">
                                                                <li><a class="dropdown-item" href="{{ route('admin.authentication.auth-signin') }}">Sign in</a></li>
                                                                <li><a class="dropdown-item" href="{{ route('admin.authentication.auth-signup') }}">Sign up</a></li>
                                                                <li><a class="dropdown-item" href="{{ route('admin.authentication.auth-password-reset') }}">Password reset</a></li>
                                                                <li><a class="dropdown-item" href="{{ route('admin.authentication.auth-two-step') }}">2-Step Authentication</a></li>
                                                                <li><a class="dropdown-item" href="{{ route('admin.authentication.auth-404') }}">404</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="nav-item dropdown">
                                                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
