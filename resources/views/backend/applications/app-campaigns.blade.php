...
<div class="row g-1">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body d-flex  align-items-center flex-column flex-md-row">
                <img class="w120 rounded-4 img-thumbnail" src="{{ url('/') }}/assets/images/gallery/1.jpg" alt="">
                <div class="media-body ms-0 ms-4 ms-xxl-5 text-md-start text-center w-100 mt-4 mt-md-0">
                    <div class="row g-0 align-items-center">
                        <div class="col-xxl-6 col-xl-5 col-lg-4 col-md-12 mb-3 mb-lg-0">
                            ...
                            <div class="text-muted">Regular (Send by time zone) 22 Dec 2021</div>
                        </div>
                        ...
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 text-center text-md-end mt-3 mt-md-0">
                            <button type="button" class="btn btn-sm btn-link color-400" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="fa fa-pencil"></i></button>
                            ...
                            <button type="button" class="btn btn-sm btn-link color-400" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy"><i class="fa fa-copy"></i></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body d-flex  align-items-center flex-column flex-md-row">
                <img class="w120 rounded-4 img-thumbnail" src="{{ url('/') }}/assets/images/gallery/2.jpg" alt="">
                <div class="media-body ms-0 ms-4 ms-xxl-5 text-md-start text-center w-100 mt-4 mt-md-0">
                    <div class="row g-0 align-items-center">
                        <div class="col-xxl-6 col-xl-5 col-lg-4 col-md-12 mb-3 mb-lg-0">
                            <h6 class="mb-1">Lucid - VueJS Admin Template & Webapp kit</h6>
                            <div class="text-muted">Regular (Send by time zone) 25 Dec 2021</div>
                        </div>
                        <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 text-center">
                            <ul class="list-unstyled d-flex mb-0 text-center text-md-start">
                                <li class="flex-fill card py-2 px-3">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body d-flex  align-items-center flex-column flex-md-row">
                <img class="w120 rounded-4 img-thumbnail" src="{{ url('/') }}/assets/images/gallery/3.jpg" alt="">
                <div class="media-body ms-0 ms-4 ms-xxl-5 text-md-start text-center w-100 mt-4 mt-md-0">
                    <div class="row g-0 align-items-center">
                        <div class="col-xxl-6 col-xl-5 col-lg-4 col-md-12 mb-3 mb-lg-0">
                            <h6 class="mb-1">Alpino - Bootstrap 4 Admin Dashboard Template</h6>
                            <div class="text-muted">Regular (Send by time zone) 26 Dec 2021</div>
                        </div>
                        <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 text-center">
                            <ul class="list-unstyled d-flex mb-0 text-center text-md-start">
                                <li class="flex-fill card py-2 px-3">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body d-flex  align-items-center flex-column flex-md-row">
                <img class="w120 rounded-4 img-thumbnail" src="{{ url('/') }}/assets/images/gallery/4.jpg" alt="">
                <div class="media-body ms-0 ms-4 ms-xxl-5 text-md-start text-center w-100 mt-4 mt-md-0">
                    <div class="row g-0 align-items-center">
                        <div class="col-xxl-6 col-xl-5 col-lg-4 col-md-12 mb-3 mb-lg-0">
                            <h6 class="mb-1">New sale LUNO Admin template</h6>
                            <div class="text-muted">Regular (Send by time zone) 31 Dec 2021</div>
                        </div>
                        <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 text-center">
                            <ul class="list-unstyled d-flex mb-0 text-center text-md-start">
                                <li class="flex-fill card py-2 px-3">
