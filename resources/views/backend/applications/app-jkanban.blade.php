        ...
        <div class="dd card fieldset border border-primary mb-5">
            ...
            <ol class="dd-list list-unstyled mb-3">
                <li class="dd-item card p-xl-3 p-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <div class="project-members">
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Avatar"><img class="avatar xs rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar7.jpg" alt="friend"> </a>
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Avatar"><img class="avatar xs rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar9.jpg" alt="friend"> </a>
                        </div>
                ...
                <li class="dd-item card p-xl-3 p-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <div class="project-members">
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Avatar"><img class="avatar xs rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar2.jpg" alt="friend"> </a>
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Avatar"><img class="avatar xs rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar3.jpg" alt="friend"> </a>
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Avatar"><img class="avatar xs rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar6.jpg" alt="friend"> </a>
                        </div>
                        <div class="task-action">
            ...
            <button class="btn rounded btn-white w-100 mt-auto" type="button" data-bs-toggle="modal" data-bs-target="#addNewTask"><i class="fa fa-plus"></i> Add task</button>
        </div>
    </div>
        ...
        <div class="dd card fieldset border border-secondary mb-5">
            ...
            <ol class="dd-list list-unstyled mb-3">
                <li class="dd-item card p-xl-3 p-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <div class="project-members">
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Avatar"><img class="avatar xs rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar8.jpg" alt="friend"> </a>
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Avatar"><img class="avatar xs rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar3.jpg" alt="friend"> </a>
                        </div>
                        <div class="task-action">
                ...
                <li class="dd-item card p-xl-3 p-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <div class="project-members">
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Avatar"><img class="avatar xs rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar2.jpg" alt="friend"> </a>
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Avatar"><img class="avatar xs rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar5.jpg" alt="friend"> </a>
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Avatar"><img class="avatar xs rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar6.jpg" alt="friend"> </a>
                        </div>
                        <div class="task-action">
                ...
                <li class="dd-item card p-xl-3 p-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <div class="project-members">
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Avatar"><img class="avatar xs rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar5.jpg" alt="friend"> </a>
                            <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Avatar"><img class="avatar xs rounded-circle" src="{{ url('/') }}/assets/images/xs/avatar1.jpg" alt="friend"> </a>
                        </div>
                        <div class="task-action">
