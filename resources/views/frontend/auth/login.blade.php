...
<div class="row">
    ...
    <div class="col-lg-6 d-flex justify-content-center align-items-center">
        <div @class(['card shadow-sm w-100 p-4 p-md-5','shadow-active' => $setting->card_box_shadow == 'Y']) style="max-width: 32rem;">
            <!-- Form -->
            <form class="row g-3" action="{{route('frontend.auth.login')}}" method="post">
                @csrf
                    ...
                    <div class="mb-2">
                        <div class="form-label">
                            <span class="d-flex justify-content-between align-items-center">
                                Password
                                <a class="text-primary" href="{{ route('frontend.auth.password.request') }}">Forgot Password?</a>
                            </span>
                        </div>
                ...
                <div class="col-12 text-center mt-4">
                    <span class="text-muted">Don't have an account yet? <a href="{{ route('frontend.auth.register') }}">Sign up here</a></span>
                </div>
            </form>
            <!-- End Form -->
        </div>
