        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-6 d-flex justify-content-center align-items-center">
                <x-frontend.card>
                    ...
                    <x-slot name="body" class="card shadow-sm w-100 p-4 p-md-5">
                        <x-forms.post :action="route('frontend.auth.password.update')" class="row g-3">
                            <input type="hidden" name="token" value="{{ $token }}" />
                             ...
                             <div class="col-12">
                                ...
                                <div class="col-md-6">
                                    <input type="email" name="email" id="email" class="form-control form-control-lg" placeholder="{{ __('E-mail Address') }}" value="{{ $email ?? old('email') }}" maxlength="255" required autofocus autocomplete="email" />
                                </div>
                                </div>
                             ...
                             <div class="col-12">
                                ...
                                <div class="col-md-6">
                                    <input type="password" id="password" name="password" class="form-control form-control-lg" placeholder="{{ __('Password') }}" maxlength="100" required autocomplete="password" />
                                </div>
                                </div>
                             ...
                             <div class="col-12">
                                ...
                                <div class="col-md-6">
                                    <input type="password" id="password_confirmation" name="password_confirmation" class="form-control form-control-lg" placeholder="{{ __('Password Confirmation') }}" maxlength="100" required autocomplete="new-password" />
                                </div>
                                </div>
